...
if (!isset($_COOKIE['auth']) || !isset($_COOKIE['username'])) {
    ...
    $checkAllowed = mysqli_fetch_array(mysqli_query($mysqli, "SELECT allowedQuality, Role, isSectionManager as isAdmin FROM packapps_master_users JOIN quality_UserData ON packapps_master_users.username=quality_UserData.UserName WHERE packapps_master_users.username = '$SecuredUserName'"));
