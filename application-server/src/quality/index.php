...
if (!isset($_COOKIE['auth']) || !isset($_COOKIE['username'])) {
    ...
    $checkAllowed = mysqli_fetch_array(mysqli_query($mysqli, "SELECT allowedQuality, Role, isSectionManager as isAdmin FROM master_users JOIN quality_UserData ON master_users.username=quality_UserData.UserName WHERE master_users.username = '$SecuredUserName'"));
