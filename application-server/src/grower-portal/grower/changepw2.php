...
<head>
    ...
    $namecnct = mysqli_query($mysqli, "SELECT GrowerName FROM `GrowerData` WHERE GrowerCode='" . $_SERVER['PHP_AUTH_USER'] . "' LIMIT 1");
    ...
    if ($_POST['NewPassword'] == $_POST['NewPassword2']) {
        ...
        mysqli_query($mysqli, "UPDATE GrowerData SET `Password`='".mysqli_real_escape_string($mysqli, $_POST['NewPassword'])."' WHERE GrowerCode='".$_SERVER['PHP_AUTH_USER']."'");
