...
mysqli_query($mysqli, "UPDATE InspectedRTs SET `DAFinished` = '1' WHERE RTNum='" . $RT . "'");

//Prepare Statements and execute queries
$stmt = mysqli_prepare($mysqli, "UPDATE `AppleSamples` SET DA=?, DA2=? WHERE `RT#`=? AND SampleNum=?");
